...
while (<FH>)
   ...
   open(CFH, "</fastdata/md1jrbx/SHOBHA/HG19_METRICS/$sample.adjusted_counts");
...
while (<FH>)
   ...
   open(CFH, "</fastdata/md1jrbx/SHOBHA/HG19_METRICS/$sample.cov");
...
while (<FH>)
   ...
   open(CFH, "</fastdata/md1jrbx/SHOBHA/HG19_METRICS/$sample.dups.metrics");
...
while (<FH>)
   ...
   open(CFH, "</fastdata/md1jrbx/SHOBHA/HG19_METRICS/$sample.inserts");
